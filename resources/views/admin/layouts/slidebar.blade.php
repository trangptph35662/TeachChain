            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse"
                        ...
                        <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Danh mục sản phẩm</span> <span
                    ...
                    <div class="collapse menu-dropdown" id="sidebarLayouts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.catelogues.create')}}" class="nav-link" data-key="t-horizontal">Thêm mới</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('admin.products.index')}}" class="nav-link" data-key="t-horizontal">DS sản phảm</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('admin.products.create')}}" class="nav-link" data-key="t-horizontal">Thêm mới sản phẩm</a>
                            </li>
                        </ul>
                    </div>
                </li> <!-- end Dashboard Menu -->
